...
#load dataset
dataframe = pd.read_csv("test-datasets/regression/buoys-measured-wave-data.csv",sep=",")
...
X_train = train_set[["signifiant wave height","wave period (zero upcrossing)",
"wave period (peak energy)","peak direction","sea surface temp (apx)"]]
y_train = train_set[["max wave height"]]

#test set features and target
X_test = test_set[["signifiant wave height","wave period (zero upcrossing)",
"wave period (peak energy)","peak direction","sea surface temp (apx)"]]
y_test = test_set[["max wave height"]]
